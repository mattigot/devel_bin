echo "Add Shared WEP128 Key 1 network"

sudo wpa_cli -i wlan3 add_network 0
sudo wpa_cli -i wlan3 set_network 0 ssid '"SHARED-WEP128-STATIC-KEY1"'
...
sudo wpa_cli -i wlan3 set_network 0 wep_key0 11111111111111111111111111
